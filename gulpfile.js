...
gulp.task("cssInject", ["minifyCSS"], function() {
  return gulp.src(MIN_CSS).pipe(browserSync.stream());
});
...
gulp.task("spritePNG", function() {
  var spriteData = gulp.src(DIR_PATH + "/dev/img/**/*.png").pipe(
    spritesmith({
      imgName: "sprite.png",
...
gulp.task("spriteJPEG", function() {
  var spriteData = gulp.src(DIR_PATH + "/dev/img/**/*.{jpeg,jpg}").pipe(
    spritesmith({
      imgName: "sprite.jpeg",
...
gulp.task("createSprite", ["beginClean"], function() {
  return gulp
    .src(DIR_PATH + "/dev/img/toSprite/**/*.svg")
...
gulp.task("copySpriteGraphic", ["createSprite"], function() {
  return gulp
    .src(DIR_PATH + "/dev/temp/sprite/css/**/*.svg")
    .pipe(gulp.dest(DIR_PATH + "/dist/img/sprites"));
});
//--copy css
gulp.task("copySpriteCSS", ["createSprite"], function() {
  return gulp
    .src(DIR_PATH + "/dev/temp/sprite/css/*.css")
